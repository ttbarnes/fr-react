  ...
  return (
    <div className={sourceSans.className}>
      <Head>
        ...
        <meta name='msapplication-TileImage' content={`${CONSTANTS.BASE_URL}/images/ms-icon-144x144.png`} />
        ...
        <link rel='apple-touch-icon' sizes='76x76' href={`${CONSTANTS.BASE_URL}/images/apple-icon-76x76.png`} />
        <link rel='apple-touch-icon' sizes='114x114' href={`${CONSTANTS.BASE_URL}/images/apple-icon-114x114.png`} />
        <link rel='apple-touch-icon' sizes='120x120' href={`${CONSTANTS.BASE_URL}/images/apple-icon-120x120.png`} />
        <link rel='apple-touch-icon' sizes='144x144' href={`${CONSTANTS.BASE_URL}/images/apple-icon-144x144.png`} />
        <link rel='apple-touch-icon' sizes='152x152' href={`${CONSTANTS.BASE_URL}/images/apple-icon-152x152.png`} />
        <link rel='apple-touch-icon' sizes='180x180' href={`${CONSTANTS.BASE_URL}/images/apple-icon-180x180.png`} />
        <link rel='icon' type='image/png' sizes='192x192' href={`${CONSTANTS.BASE_URL}/images/android-icon-192x192.png`} />
        <link rel='icon' type='image/png' sizes='32x32' href={`${CONSTANTS.BASE_URL}/images/favicon-32x32.png`} />
        <link rel='icon' type='image/png' sizes='96x96' href={`${CONSTANTS.BASE_URL}/images/favicon-96x96.png`} />
        <link rel='icon' type='image/png' sizes='16x16' href={`${CONSTANTS.BASE_URL}/images/favicon-16x16.png`} />
        <link rel='shortcut icon' href={`${CONSTANTS.BASE_URL}/images/favicon.ico`} type='image/x-icon' />
      </Head>
