      ...
      <div className='main-content'>
        <div className={styles.container}>
          ...
          <div className={styles.textContentContainer}>
            ...
            <p>Award winning vocalist, pianist, composer and producer Fiona Ross has become known for creating her own contemporary Jazz sound using fast paced Latin Jazz, vintage jazz club and a little neo soul along with heart wrenching ballads that demonstrate that <span className='highlight'><i>'Her style is poetic and the messages ooze with Millennial angst'</i> (Jazz weekly)</span>.</p>
          
            <p>She came to the world’s attention as <span className='highlight'><i>'The artist that gave Ed Sheeran his 'first push''</i> (Daily Express)</span>, but has very quickly established herself as an artist in her own right and has received incredible reviews across the globe for all of her four albums. Her live performances have seen her perform at prestigious venues including 606 Club, Pizza Express, Bulls Head, Nells Jazz and Blues and Toulouse Lautrec and her music is played on radio stations all over the world including 40 stations in the USA as well as in Canada, Italy, France, Germany, Australia, Nertherlands and Spain.</p>
