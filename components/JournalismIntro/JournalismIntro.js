...
const JournalismIntro = () => (
  <div className={styles.container}>
    ...
    <p>Fiona has interviewed an impressive list of inspirational artists including Rickie Lee Jones, Regina Carter, Brandee Younger, Jazzmeia Horn,Steve Gadd, Michel Camilo, Kyle Eastwood, Dee Dee Bridgewater, Maxine Gordon, Terri Lyne Carrington, Barbara Thompson OBE, Ruby Turner, Hiromi, Camille Thurman, Celine Peterson, Jordannah Elizabeth and Dr Tammy Kernodle.</p>
