...
const JournalismIntro = () => (
  <div className={styles.container}>
    <p>As well as working as a Jazz artist, Fiona spends her time behind the scenes in Jazz working as the founder of <LinkWIJM />, senior writer for <LinkJazzInEurope /> and writing for publications including <LinkKindOfJazz />, <LinkJazzNorth />, <LinkJazzUk /> and <LinkConnectsMusic />. Fiona was the guest editor in chief for the January 2021 edition of <LinkJazzQuarterly />, where she was responsible for a rarely seen fully diverse and gender balanced Jazz publication.</p>

    <p>Fiona has interviewed an impressive list of inspirational artists including Rickie Lee Jones, Regina Carter, Brandee Younger, Jazzmeia Horn,Steve Gadd, Michel Camilo, Kyle Eastwood, Dee Dee Bridgewater, Maxine Gordon, Terri Lyne Carrington, Barbara Thompson OBE, Ruby Turner, Hiromi, Camille Thurman, Celine Peterson, Hiromi, Jordannah Elizabeth and Dr Tammy Kernodle.</p>
