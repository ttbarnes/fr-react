...
const LinkTCTTLTopPodcast = () => (
  <a className='link-highlight-hover-border' href='https://podcasts.feedspot.com/uk_music_podcasts/?feedid=5573991' target='_blank' rel='noopener noreferrer'>Top 60 UK Music Podcasts on the web</a>
);

const LinkTCTTLapple = () => (
  <a className='link-highlight-hover-border' href='https://podcasts.apple.com/gb/podcast/thoughts-conversations-and-to-do-lists/id1685136847?ign-itscg=30200&ign-itsct=podtail_podcasts' target='_blank' rel='noopener noreferrer'>Apple</a>
);

const LinkTCTTLspotify = () => (
  <a className='link-highlight-hover-border' href='https://open.spotify.com/show/6DYV6dMGODtj0A2SBxgUaP' target='_blank' rel='noopener noreferrer'>Spotify</a>
);

const LinkTCTTLukPodcasts = () => (
  <a className='link-highlight-hover-border' href='https://uk-podcasts.co.uk/podcast/thoughts-conversations-and-to-do-lists' target='_blank' rel='noopener noreferrer'>UK Podcasts</a>
);

const LinkTCTTLgoogle = () => (
  <a className='link-highlight-hover-border' href='https://podcasts.google.com/feed/aHR0cHM6Ly9hbmNob3IuZm0vcy9kZDcyNDhlNC9wb2RjYXN0L3Jzcw' target='_blank' rel='noopener noreferrer'>Google</a>
);
...
const JournalismIntro = () => (
  <div className={styles.container}>
    <p>As well as working as a Jazz artist, Fiona spends her time behind the scenes in Jazz working as the founder of <LinkWIJM />, senior writer for <LinkJazzInEurope /> and writing for a range of publications including <LinkKindOfJazz />, <LinkJazzNorth />, <LinkJazzUk /> and <LinkConnectsMusic />. Fiona was the guest editor in chief for the January 2021 edition of <LinkJazzQuarterly />, where she was responsible for a rarely seen fully diverse and gender balanced Jazz publication. She was recently recognised for her work and awarded the <LinkJazzJournalists /> Jazz Heroes 2026 award.</p>

    <p>Fiona has interviewed an impressive list of inspirational artists including Rickie Lee Jones, Regina Carter, Brandee Younger, Jazzmeia Horn, Steve Gadd, Michel Camilo, Kyle Eastwood, Dee Dee Bridgewater, Maxine Gordon, Terri Lyne Carrington, China Moses, Barbara Thompson OBE, Ruby Turner, Hiromi, Camille Thurman, Celine Peterson, Jordannah Elizabeth, Nothembo Madumo and Dr Tammy Kernodle.</p>
